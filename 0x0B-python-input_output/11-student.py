...
class Student:
    ...
    def reload_from_json(self, json):
        """
        Replaces all attributes of the Student instance based on a provided JSON dictionary.

        Args:
            json (dict): The JSON dictionary containing the attribute names and values.
